...
| :--- | :--- | :--- | :--- | :--- | :--- |
| [automated-testing/](automated-testing/SKILL.md) | automated-testing | `automated-testing` | `1.0.0` | 🟢 开启中 (Active) | guidelines for running build checks and compiling verification. Use this to verify frontend correctness after modifying Next.js pages, Zustand stores, or components, and before making commits. |
